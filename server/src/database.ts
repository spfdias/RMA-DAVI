...
async function seedData(): Promise<void> {
  ...
  if (acolhidoCount && acolhidoCount.total === 0) {
    const acolhidos = [
      ...
      { nome: 'Deysi Michele Da Silva Ribeiro', data_nascimento: '2024-06-01', data_acolhimento: '2024-05-09', sexo: 'Feminino' },
      { nome: 'Elias Ezequiel De Almeida Gimenes', data_nascimento: '2025-09-01', data_acolhimento: '2025-09-05', sexo: 'Masculino' },
      { nome: 'Emanuelly Beatriz Rodrigues Sampaio', data_nascimento: '2024-06-01', data_acolhimento: '2026-03-11', sexo: 'Feminino' },
      ...
      { nome: 'Gabrielle Eloá Ribas Ribeiro', data_nascimento: '2020-06-01', data_acolhimento: '2025-06-07', sexo: 'Feminino' },
      ...
      { nome: 'Luana Trindade Rojas Pereira', data_nascimento: '2012-06-01', data_acolhimento: '2024-05-10', sexo: 'Feminino' },
      ...
      { nome: 'Ludimila Benites Ribeiro', data_nascimento: '2009-06-01', data_acolhimento: '2026-01-30', sexo: 'Feminino' },
      { nome: 'Luiz Miguel Rodrigues Sampaio', data_nascimento: '2023-03-11', data_acolhimento: '2026-03-11', sexo: 'Masculino' },
      { nome: 'Marta Pereira Da Silva', data_nascimento: '2012-06-01', data_acolhimento: '2026-01-29', sexo: 'Feminino' },
      ...
      { nome: 'Raphaella Matos Escobar', data_nascimento: '2010-06-01', data_acolhimento: '2026-03-02', sexo: 'Feminino' },
      { nome: 'Sandriele Batista Isnarde', data_nascimento: '2009-06-01', data_acolhimento: '2020-07-17', sexo: 'Feminino' },
      { nome: 'Thais Cabreira Benites', data_nascimento: '2009-06-01', data_acolhimento: '2026-03-23', sexo: 'Feminino' },
      { nome: 'Vitória Gabriela Silva', data_nascimento: '2010-06-01', data_acolhimento: '2026-03-27', sexo: 'Feminino' },
      { nome: 'Yngrid Vitória Dos Santos', data_nascimento: '2025-06-01', data_acolhimento: '2025-12-12', sexo: 'Feminino' },
    ];
